...
> [v0.2.1](docs/releases/v0.2.1.md) adds per-mount OAuth credentials, an optional OneDrive root folder, the iList product name, and explorer chrome fixes. Read the [release guide](docs/releases/v0.2.1.md) before upgrading. v0.1.8 security hardening remains required; see [v0.1.8](docs/releases/v0.1.8.md).
